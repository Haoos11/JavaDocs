...
public class Student {
    ...
    public String toString() {
        String string = this.getClass().getSimpleName() + ":" + getFirstName()
                + " " + getLastName();
        return string;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (this.firstName == ((Student) o).firstName &&
                this.lastName == ((Student) o).lastName&&
                this.id == ((Student) o).id&&
                this.averageGrade == ((Student) o).averageGrade)
            return true;
