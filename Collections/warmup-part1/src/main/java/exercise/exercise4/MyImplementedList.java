...
public class MyImplementedList<E> {
    ...
    public E set(int index, E element){
        ...
        if (index<=size)
            ...
            System.out.println("index mai mare");
    ...
    void extendCapacity(int capacity) {
        if (size >= (LOAD_FACTOR * capacity))
            ...
            Object[] auxElementData = new Object[capacityAfterExtending];

            for (int i=0; i<size; i++)
                auxElementData[i] = elementData[i];

            this.elementData = auxElementData;
    ...
    public Iterator<E> iterator(){
        ...
        Iterator<E> it = new Iterator<E>() {
            ...
            public void remove() {
                pos--;
                MyImplementedList.this.remove(pos);
            }
