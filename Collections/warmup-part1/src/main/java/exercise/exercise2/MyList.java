...
public class MyList<Integer> extends ArrayList<Integer> {
    ...
    @Override
    public boolean addAll(int index, Collection<? extends Integer> c) { //colectia are doar elem instanceof Integer
        ArrayList<Integer> list2 = new ArrayList<Integer>();

        for (Integer i: c) {
            if(!super.contains(i) && !list2.contains(i)) {
                differentElements++;
                list2.add(i);
            }
        }
    ...
    @Override
    public boolean addAll(Collection<? extends Integer> c) { //colectia are doar elem instanceof Integer
